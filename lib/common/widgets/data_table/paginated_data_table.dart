    ...
    return SizedBox(
      ...
      child: Theme(
        ...
        child: PaginatedDataTable2(
          ...
          headingRowColor: WidgetStateProperty.resolveWith((states) => EColors.primaryBackground),
          empty: EAnimationLoaderWidget(animation: EImages.packageAnimation, text: 'Nothing Found', height: 200, width: 200),
          ...
          sortArrowBuilder: (bool ascending, bool sorted) {
            if (sorted) {
              return Icon(ascending ? Iconsax.arrow_up_3 : Iconsax.arrow_down, size: ESizes.iconSm);
            } else {
              return const Icon(Iconsax.arrow_3, size: ESizes.iconSm);
            }
          },
        ),
      ),
