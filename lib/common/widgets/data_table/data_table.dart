...
class EDataEable extends StatelessWidget {
  const EDataEable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor: WidgetStateProperty.resolveWith((states) => EColors.primaryColor),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(ESizes.borderRadiusMd)),
        ),
        // Set the decoration for the heading row of the data table
        headingRowDecoration: const BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(ESizes.borderRadiusMd), topRight: Radius.circular(ESizes.borderRadiusMd)),
        ),
      ),
    );
  }
